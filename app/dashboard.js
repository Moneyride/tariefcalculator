(function initializeDashboard() {
  ...
  const DEV_BADGE_CATALOG = [
    ...
    ["eerste_productie", "Eerste Productie", "Alle dagen van je eerste project zijn afgelopen en hebben een eindtijd, of zijn reisdagen.", "📂", false],
    ...
    ["long_runner", "Long Runner", "Een project met minimaal 10 dagen: alle dagen zijn afgelopen en hebben een eindtijd, of zijn reisdagen.", "🎞️", true],
    ["paperwork_hero", "Paperwork Hero", "Je eerste werkdag- of project-PDF is gemaakt.", "📄", true],
    ...
    ["launch_crew", "Launch Crew", "Account aangemaakt van 1 juli 2026 tot 1 juli 2027.", "🚀", true],
