-- Keep direct shares live and notify every participant when an end time is saved.
-- Run after 202607280002_shared_private_participants.sql.
...
comment on function public.sync_shared_workday_times() is
  'Delivers completion shares and notifies all recipients when shared start or end times change.';
