...
De tool draait helemaal lokaal in je browser.
Er is geen login, database, internetverbinding of installatie nodig.

Snel gebruiken

1. Open deze map.
2. Open "Tariefcalculator.html".
3. De tariefcalculator opent in je browser.

Op een telefoon werkt "Tariefcalculator.html" het beste, omdat alles in één bestand zit.
